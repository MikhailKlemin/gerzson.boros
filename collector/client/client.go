...
func (m *MyClient) GetByte(link string) (b []byte, err error) {
	...
	req.Header.Add("User-Agent", "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:82.0) Gecko/20100101 Firefox/82.0")
	req.Header.Add("Accept", "text/html,*/*")
	req.Header.Add("Accept-Language", "en-US,en;q=0.5")
	req.Header.Add("X-Requested-With", "XMLHttpRequest")
	req.Header.Add("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Add("contentType", "application/x-www-form-urlencoded;charset=utf-8")
